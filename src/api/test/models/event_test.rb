...
class EventTest < ActionDispatch::IntegrationTest
  ...
  test 'find subscribers' do
    ...
    EventSubscription.create(eventtype: 'Event::CommentForProject',
                             user: users(:fred), receiver_role: :maintainer, channel: :instant_email, enable: false)
    ...
    EventSubscription.create(eventtype: 'Event::CommentForProject',
                             user: users(:fredlibs),
                             receiver_role: :maintainer, channel: :instant_email, enable: true)
  ...
  test 'maintainer mails for build failure' do
    ...
    EventSubscription.create(eventtype: 'Event::BuildFail', receiver_role: :maintainer, user: users(:Iggy), channel: :instant_email, enable: true)
  ...
  test 'reader mails for build failure' do
    ...
    # just one subsciption
    EventSubscription.create(eventtype: 'Event::BuildFail', receiver_role: :reader, user: users(:fred), channel: :instant_email, enable: true)
  ...
  test 'maintainer mails for source service fail' do
    ...
    # just one subsciption
    EventSubscription.create(eventtype: 'Event::ServiceFail', receiver_role: :maintainer, user: users(:Iggy), channel: :instant_email, enable: true)
