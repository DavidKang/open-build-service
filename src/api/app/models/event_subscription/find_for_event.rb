class EventSubscription
  class FindForEvent
    ...
    def subscriptions(channel = :instant_email)
      ...
      event.class.receiver_roles.flat_map do |receiver_role|
        ...
        receivers.each do |receiver|
          ...
          receiver_subscription = find_user_subscription(receiver, options)
    ...
    def find_user_subscription(receiver, options)
      EventSubscription.for_subscriber(receiver).find_by(options) ||
        EventSubscription.for_subscriber(receiver).find_by(options.merge(channel: :disabled))
    end
