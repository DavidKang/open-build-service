...
RSpec.describe Webui::Users::NotificationsController do
  ...
  let(:state_change_notification) { create(:web_notification, :request_state_change, subscriber: user, web: true) }
  let(:creation_notification) { create(:web_notification, :request_created, subscriber: user, web: true) }
  let(:review_notification) { create(:web_notification, :review_wanted, subscriber: user, web: true) }
  let(:comment_for_project_notification) { create(:web_notification, :comment_for_project, subscriber: user, web: true) }
  let(:comment_for_package_notification) { create(:web_notification, :comment_for_package, subscriber: user, web: true) }
  let(:comment_for_request_notification) { create(:web_notification, :comment_for_request, subscriber: user, web: true) }
  let(:read_notification) { create(:web_notification, :request_state_change, subscriber: user, delivered: true, web: true) }
  let(:notifications_for_other_users) { create(:web_notification, :request_state_change, subscriber: other_user, web: true) }
