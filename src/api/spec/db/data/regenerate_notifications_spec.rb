...
RSpec.describe RegenerateNotifications, type: :migration do
  describe 'up' do
    ...
    context 'for RequestCreate Notifications' do
      let!(:subscription) { create(:event_subscription_request_created, receiver_role: 'target_maintainer', user: owner, channel: :rss) }
    ...
    context 'for ReviewWanted Notifications' do
      ...
      context 'with review by project and by package' do
        ...
        let!(:subscription) { create(:event_subscription_review_wanted, receiver_role: 'reviewer', user: reviewer_1, channel: :rss) }
